...
const monthly: Localized = { zh: "月付", en: "monthly" };
const oneTime: Localized = { zh: "一次性", en: "one-time" };
const allModels: Localized = { zh: "全部模型", en: "All models" };
const noRateLimit: Localized = { zh: "不限速", en: "No rate limit" };
const noParallelLimit: Localized = { zh: "无限制", en: "Unlimited" };
const singleMediaRate: Localized = { zh: "1×", en: "1x" };
const followsPlan: Localized = { zh: "跟随当前 Plan", en: "Follows current Plan" };
const extendsSubscription: Localized = { zh: "延续订阅", en: "Extends subscription" };
const requiresPlan: Localized = { zh: "需持有任意一种 Plan 才可购买。", en: "Requires any active Plan." };
const creditsFirstNote: Localized = {
  zh: "先扣加购包，再扣订阅额度。",
    ...
    variants: [
      {
        ...
        credits: "8,137",
        models: { zh: "Spark+ 优选模型", en: "Spark+ preferred models" },
        rateLimit: uni("50 RPM"),
        parallelLimit: uni("15"),
    ...
    variants: [
      {
        ...
        credits: "12,226",
        models: { zh: "Spark+ 优选模型", en: "Spark+ preferred models" },
        rateLimit: uni("75 RPM"),
        parallelLimit: uni("25"),
        mediaRate: singleMediaRate,
        note: {
    ...
    variants: [
      {
        ...
        credits: "1,254",
        models: followsPlan,
        rateLimit: followsPlan,
        parallelLimit: followsPlan,
        mediaRate: extendsSubscription,
        note: requiresPlan,
      },
    ],
  },
