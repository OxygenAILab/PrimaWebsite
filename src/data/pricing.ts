...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    note: { zh: "适合稳定使用图像、音频与长文本能力的个人创作者。", en: "For creators who steadily use image, audio, and long-text capabilities." },
  },
  {
    family: "SparkPlan",
    tier: "Plus",
  ...
  },
  {
    ...
    note: { zh: "适合把模型能力接入内部工具的小型团队。", en: "For small teams connecting model capabilities to internal tools." },
  },
  {
    family: "PrimaPlan",
    tier: "Plus 2x",
    ...
    mediaRate: { zh: "1×", en: "1x" },
    note: { zh: "面向需要更高吞吐的团队工作流。", en: "For team workflows that need higher throughput." },
  },
  {
    family: "PrimaPlan",
    tier: "Plus 5x",
    ...
    parallelLimit: { zh: "无限制", en: "Unlimited" },
    mediaRate: { zh: "1×", en: "1x" },
    note: { zh: "适合多成员并行使用统一额度的团队。", en: "For teams using one shared allocation across members in parallel." },
  },
  {
    family: "PrimaPlan",
    tier: "Pro 5x",
    ...
    parallelLimit: { zh: "无限制", en: "Unlimited" },
    mediaRate: { zh: "1×", en: "1x" },
    note: { zh: "先扣加购包，再扣订阅额度。", en: "Credit packs are consumed before subscription credits." },
  },
  {
    family: "PrimaPlan",
    tier: "Pro 10x",
